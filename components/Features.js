        ...
        <div className="space-y-16 md:space-y-24">
          <div className="transition duration-500 ease-in-out transform scale-100 translate-x-0 translate-y-0 opacity-100">
            <div className="space-y-5 md:text-center">
              ...
              <p className="text-xl text-gray-200 md:text-2xl">
                Each feature is specifcially made with ease and aimed
          ...
          <div className="grid grid-cols-1 grid-rows-2 gap-8 text-lg md:grid-cols-2 lg:grid-cols-3">
            <div className="flex shadow-md hover:shadow-[#00e4ff] flex-col justify-between p-5 transition duration-400 bg-white bg-opacity-20 rounded-xl card-hover group space-y-5">
              ...
              >
  <path   d="M13.325 3.05L8.667 20.432l1.932.518 4.658-17.382-1.932-.518zM7.612 18.36l1.36-1.448-.001-.019-5.094-4.78 4.79-5.105-1.458-1.369-6.16 6.563 6.563 6.159zM16.388 18.36l-1.36-1.448.001-.019 5.094-4.78-4.79-5.105 1.458-1.369 6.16 6.563-6.563 6.159z"  />              </svg>
              <h3 className="text-xl font-semibold text-white">
              Software Development
              </h3>
              <p className="text-gray-200">
              Tailor-made software solutions to propel your business.
Expertise in List your development specialties: Web, Mobile, Enterprise etc.
              </p>
            </div>
            <div className="flex shadow-md hover:shadow-[#00e4ff] flex-col justify-between p-5 transition duration-400 bg-white bg-opacity-20 rounded-xl card-hover group space-y-5">
              <svg
              ...
              <p className="text-gray-200">
              User-centric designs that are intuitive and visually stunning.
We craft experiences that resonate with your target audience.
              </p>
            </div>
            <div className="flex shadow-md hover:shadow-[#00e4ff] flex-col justify-between p-5 transition duration-400 bg-white bg-opacity-20 rounded-xl card-hover group space-y-5">
              <svg
              ...
              <p className="text-gray-200">
              Reliable and responsive support to keep your software running smoothly.
